...
url: https://docs.attio.com/sdk/introduction/server/webhooks/update-webhook-handler
crawled_at: unknown
depth: 2
...
**Source:** [https://docs.attio.com/sdk/introduction/server/webhooks/update-webhook-handler](https://docs.attio.com/sdk/introduction/server/webhooks/update-webhook-handler)
