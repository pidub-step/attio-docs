...
url: https://docs.attio.com/sdk/server/server-functions/available-globals
crawled_at: unknown
depth: 3
parent_url: https://docs.attio.com/sdk/server/server-functions
---

# Overview - Attio Docs

**Source:** [https://docs.attio.com/sdk/server/server-functions/available-globals](https://docs.attio.com/sdk/server/server-functions/available-globals)
