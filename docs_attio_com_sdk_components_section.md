---
title: <Section /> - Attio Docs
url: https://docs.attio.com/sdk/components/section
crawled_at: unknown
depth: 2
...
**Source:** [https://docs.attio.com/sdk/components/section](https://docs.attio.com/sdk/components/section)
...
![](https://mintlify.s3.us-west-1.amazonaws.com/attio/images/section.png) ![](https://mintlify.s3.us-west-1.amazonaws.com/attio/images/section-dark.png)
Copy
```
...
## 
[​](https://docs.attio.com/sdk/components/section#props)
Props
### 
[​](https://docs.attio.com/sdk/components/section#title-%3A-string)
`title : string`
The title of the section. It will be displayed in a stronger font than the content of the section.
### 
[​](https://docs.attio.com/sdk/components/section#children-%3A-react-reactnode)
`children : React.ReactNode`
The text (or components) content of the section.
Was this page helpful?
YesNo
[<Row />](https://docs.attio.com/sdk/components/row)[<SubmitButton />](https://docs.attio.com/sdk/components/submit-button)
[x](https://x.com/Attio)[website](https://attio.com)
[Powered by Mintlify](https://mintlify.com/preview-request?utm_campaign=poweredBy&utm_medium=referral&utm_source=docs.attio.com)
On this page
  * [Props](https://docs.attio.com/sdk/components/section#props)
  * [title : string](https://docs.attio.com/sdk/components/section#title-%3A-string)
  * [children : React.ReactNode](https://docs.attio.com/sdk/components/section#children-%3A-react-reactnode)
